...
<main >
    ...
    <section class="ui basic segment container">
      ...
      <?php 
      $genres = $genreGate->findAllSorted(true);
      // loop thru genres 
      foreach ($genres as $genre) {
      ?>
            <div class="centered card">
                <div class="ui fluid image">
                    <a href="single-genre.php?id=<?= $genre->GenreID ?>"><img src="images/art/genres/square-medium/<?= $genre->GenreID ?>.jpg"></a>
                </div>
                <div class="content">
                    <h5 class="header"><a href="single-genre.php?id=<?= $genre->GenreID;  ?>"><?= $genre->GenreName;  ?></a></h5>
                </div>          
            </div>
